const animalNames = [
  ...
  'Echidna', 'Eel', 'Eland', 'Elephant', 'Elk', 'Emu', 'Falcon', 'Ferret',
  'Finch', 'Fish', 'Flamingo', 'Fly', 'Fox', 'Frog', 'Gaur', 'Gazelle',
  ...
  'Otter', 'Owl', 'Oyster', 'Panther', 'Parrot', 'Partridge', 'Peafowl', 'Pelican',
  'Penguin', 'Pheasant', 'Pig', 'Pigeon', 'Pony', 'Porcupine', 'Porpoise', 'Quail',
  'Quelea', 'Quetzal', 'Rabbit', 'Raccoon', 'Rail', 'Ram', 'Rat', 'Raven',
  'Reindeer', 'Rhinoceros', 'Rook', 'Salamander', 'Salmon', 'Sandpiper', 'Sardine', 'Scorpion',
  ...
  'Weasel', 'Whale', 'Wildcat', 'Wildebeest', 'Wolf', 'Wolverine', 'Wombat', 'Woodcock',
...
export function generateWorkflowName(): string {
  return `${getRandomAnimalName()} Workflow`;
}